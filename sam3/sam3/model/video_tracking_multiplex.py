...
try:
    ...
    # Python 3.8/3.9/3.10 compat:
    # - Iterable, Optional, TypedDict are always in typing
    # - Literal was added in 3.8, so it's fine
    # - NotRequired, Required were added in 3.11 (and typing_extensions >= 3.10.0)
    from typing import Iterable, Literal, Optional, TypedDict
    try:
        from typing_extensions import NotRequired, Required
    except ImportError:
        # typing_extensions < 3.10 fallback: stub them
        NotRequired = lambda t: t  # type: ignore[misc]
        Required = lambda t: t     # type: ignore[misc]
